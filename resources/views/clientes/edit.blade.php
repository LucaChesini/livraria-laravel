...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: `/api/clientes/${clientId}/busca`,
            method: 'GET',
            success: function(response) {
                $('#nome').val(response.clientes.nome);
                $('#cpf').val(response.clientes.cpf);
                $('#dataNascimento').val(response.clientes.dataNascimento);
                $('#telefone').val(response.clientes.telefone);
            },
            error: function(response) {
                console.error('Erro ao obter detalhes do cliente:', response);
            }
        });
